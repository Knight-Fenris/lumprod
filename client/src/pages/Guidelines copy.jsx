...
const submissionRules = [
  ...
  { 
    ...
    desc: 'The Northern Ray: 5-20 min | Prism: 5-15 min | Vérité: 8-20 min | Lumiere Sprint: 3-7 min | Vertical Ray: Max 60 seconds. Submissions exceeding limits may be disqualified.',
    icon: '⏱️',
  },
  { 
