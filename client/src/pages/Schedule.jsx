...
const schedule = {
  day1: {
    ...
    badge: 'day1',
    events: [
      { time: '09:00 AM', name: 'Focus Desk', type: 'Registration & Kit Distribution', venue: 'Main Foyer', icon: '👥' },
      { time: '10:30 AM', name: 'The First Light', type: 'Opening Ceremony & Theme Reveal', venue: 'Auditorium', icon: '💡' },
      { time: '12:00 PM', name: 'Lumiere Sprint Kickoff', type: '48-Hour Challenge Topic Release', venue: 'Auditorium', icon: '🎬' },
      { time: '02:00 PM', name: 'Screening: The Northern Ray', type: 'Regional Film Showcase + Q&A', venue: 'Auditorium', icon: '🎥' },
      { time: '02:30 PM', name: 'Workshop: Aperture Lab', type: 'Cinematography Masterclass', venue: 'Seminar Hall', icon: '📸' },
      { time: '04:30 PM', name: 'Panel: Illuminate', type: 'Discussion: "Voices of the North"', venue: 'Auditorium', icon: '🎤' },
      { time: '06:30 PM', name: 'Under the Stars', type: 'Open Air Cinema Night', venue: 'Amphitheatre', icon: '🌟' },
    ],
  },
  day2: {
    ...
    badge: 'day2',
    events: [
      { time: '10:00 AM', name: 'Screening: Prism', type: 'National Student Shorts Competition', venue: 'Auditorium', icon: '🎬' },
      { time: '11:00 AM', name: 'Workshop: Script & Shadow', type: 'Screenwriting Lab', venue: 'Seminar Hall', icon: '✍️' },
      { time: '02:00 PM', name: 'Screening: Vérité', type: 'Documentary & Experimental Showcase', venue: 'Auditorium', icon: '🎥' },
      { time: '02:30 PM', name: 'Workshop: Splice', type: 'The Art of Editing (Premiere/DaVinci)', venue: 'Computer Lab', icon: '✂️' },
      { time: '04:30 PM', name: 'Focus Circle', type: 'Creators Roundtable (Networking)', venue: 'Foyer', icon: '☕' },
      { time: '06:30 PM', name: 'Rhythm & Light', type: 'Cultural Evening & Folk Performance', venue: 'Auditorium', icon: '🎵' },
    ],
  },
  day3: {
    ...
    badge: 'day3',
    events: [
      { time: '10:00 AM', name: 'Sprint Submission', type: 'Deadline for Lumiere Sprint', venue: 'Desk/Online', icon: '⏰' },
      { time: '11:00 AM', name: 'Screening: Sprint Top 10', type: 'Best of 48-Hour Challenge', venue: 'Auditorium', icon: '🎬' },
      { time: '11:30 AM', name: 'Workshop: Chroma', type: 'Design for Cinema (Posters/VFX)', venue: 'Seminar Hall', icon: '🎨' },
      { time: '02:00 PM', name: 'Talk: Projection Path', type: 'Industry Career Keynote', venue: 'Auditorium', icon: '🎯' },
      { time: '03:30 PM', name: 'Jury Focus', type: 'Closed Door Deliberation', venue: 'Conference Room', icon: '🔒' },
      { time: '05:30 PM', name: 'The Luminous Gala', type: 'Awards Night & Closing Ceremony', venue: 'Auditorium', icon: '🏆' },
    ],
  },
};
