...
const faqs = [
  ...
  },
  {
    ...
    answer: 'The Northern Ray: ₹499 per team | Prism Showcase: ₹599 per team | Lumiere Sprint: ₹200 per team | Vertical Ray: ₹149 per entry. All fees are non-refundable.',
  },
  {
      ...
      <div className="container">
        <div className="page-header">
          ...
          <p style={{ color: 'var(--text-secondary)', marginTop: '0.5rem' }}>
            Everything you need to know about LUMIERE 2026
          </p>
        </div>
        ...
        <section className="card" style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
            Contact us at <a href="mailto:pdc@pec.edu.in" style={{ color: '#a78bfa' }}>pdc@pec.edu.in</a> or reach out on our social media.
          </p>
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/guidelines" className="btn btn-secondary">View Guidelines</Link>
            <Link to="/submit" className="btn btn-primary">Submit Your Film</Link>
          </div>
        </section>
      </div>
    </div>
