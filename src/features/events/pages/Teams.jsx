    ...
    <main className="teams-page">
      ...
      <section className="tm-spotlight-wrap">
        ...
        <div className="tm-spotlight-grid">
          {teamContent.leadership.map((member, index) => (
            <TeamCard
              key={`leadership-${member.role}-${member.name}-${member.committee}-${index}`}
              member={member}
              featured
              accent="gold"
            />
        ...
        <section key={tier.title} className="tm-tier-section">
          ...
          <div className="tm-tier-grid">
            {tier.members.map((member, index) => (
              <TeamCard
                key={`${tier.title}-${member.committee}-${member.name}-${index}`}
                member={member}
                accent={tier.accent}
              />
            ))}
      ...
      <section className="tm-tier-section">
        ...
        <div className="tm-tier-grid">
          {teamContent.developers.map((member, index) => (
            <TeamCard
              key={`developers-${member.role}-${member.name}-${member.committee}-${index}`}
              member={member}
              accent="blue"
            />
          ))}
